        ...
        <jsp:include page="header.jsp"></jsp:include>
            ...
            <jsp:include page="menu.jsp"></jsp:include>
                ...
                <div id="rightContent">
                    ...
                    <a href="/LaptopShop/admin/insert_product.jsp">Thêm sản phẩm</a>
                    <table class="data">
                        <tr class="data">
                    ...
                    <tr class="data">
                        ...
                        <td class="data"><img class="hinhql" src="/LaptopShop/<%=product.getProductImage()%>"/></td>
                    ...
                    <center>
                        <a href="/LaptopShop/admin/update_product.jsp?command=update&product_id=<%=product.getProductID()%>">Sửa</a>&nbsp;| &nbsp;
                        <a href="/LaptopShop/ManagerProductServlet?command=delete&product_id=<%=product.getProductID()%>">Xóa</a>
                    </center>
                    </td>
                    </tr>
                    <% }%>
